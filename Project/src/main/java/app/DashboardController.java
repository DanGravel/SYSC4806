...
@Controller
public class DashboardController extends app.Controller {
    @Autowired
    private ArticleRepository articleRepository;

    /***
     * Adds all the reviewers to the model for the dropdown menu in dashboard.html
     ...
     * @return The dashboard.html view
     */
     ...
     * @return The dashboard.html view reloaded
     */
